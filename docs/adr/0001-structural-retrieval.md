...
inputs: [docs/prd.md, docs/intents/0004-capture-a-session.md, docs/intents/0006-ask-my-course.md, docs/intents/0007-quiz-me.md, docs/intents/0008-see-my-readiness.md, CLAUDE.md]
updated: 2026-09-08
---
...
Four requirements — 0006, 0007, 0008 and, upstream of them, 0004 — need to select which of
...
given them. Intent 0006's second open question is exactly this, and it stays open.
...
rather than accurate — turning requirement 0006's honest-refusal behaviour into a defect.

## Binds

| Requirement ID | How this constrains it |
|---|---|
| 0004 | Assigning material to a session is the index, so it cannot be optional or deferred; a session with unassigned material is unreachable |
| 0006 | Scope is learner-set and must be enumerable at request time; no widening of scope by the product |
| 0007 | Practice is generated from an enumerated session set, which is why single-session practice is as cheap as many |
| 0008 | Evidence for an objective is found by reading the learner's sessions, not by matching text against the objective |
